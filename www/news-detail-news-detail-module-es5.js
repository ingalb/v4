...
/* harmony import */ var ionic_header_parallax__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ionic-header-parallax */ "./node_modules/ionic-header-parallax/fesm5/ionic-header-parallax.js");
...
module.exports = "ion-card {\n  border-radius: 0;\n}\n\n.parallax-title {\n  opacity: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NewsDetailPage = /** @class */ (function () {
    function NewsDetailPage(NewsService, activatedRoute, socialSharing) {
        this.NewsService = NewsService;
        this.activatedRoute = activatedRoute;
        this.socialSharing = socialSharing;
        this.isLoaded = false;
    }
    NewsDetailPage.prototype.loadInfoNews = function () {
        var _this = this;
        this.NewsService.getInfoNews(this.newsId).subscribe(function (news) {
            _this.news = news;
            _this.title = _this.news[0].title;
            _this.imgsrc = "http://www.fkvllaznia.net/main/vllaznia/_files/newspublish/" + _this.news[0].image;
            _this.summary = _this.news[0].summary;
            _this.data = _this.news[0].data;
            _this.article = _this.news[0].content;
            _this.isLoaded = true;
        });
    };
    NewsDetailPage.prototype.shareNews = function () {
        this.socialSharing.share('Lexo lajmin per Vllaznine', this.title, this.imgsrc, 'http://www.fkvllaznia.com/lajme/' + this.newsId + '-mobile.html').then(function () {
    ...
    NewsDetailPage.ctorParameters = function () { return [
