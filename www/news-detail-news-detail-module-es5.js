(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["news-detail-news-detail-module"], {
  ...
  function srcAppNewsDetailNewsDetailModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _news_detail_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./news-detail.page */
  ...
  function srcAppNewsDetailNewsDetailPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/router */
    "./node_modules/@angular/router/fesm2015/router.js"); //import { SocialSharing } from '@ionic-native/social-sharing/ngx';
    ...
    let NewsDetailPage = class NewsDetailPage {
      ...
      shareNews() {// this.socialSharing.share('Lexo lajmin per Vllaznine', this.title, this.imgsrc, 'https://www.fkvllaznia.com/lajme/'+this.newsId+'-mobile.html').then(() => {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_api_vllaznia_service__WEBPACK_IMPORTED_MODULE_2__["VllazniaService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])], NewsDetailPage);
    /***/
  }
}]);
