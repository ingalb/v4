...
/*!*****************************************!*\
  !*** ./src/app/api/vllaznia.service.ts ***!
  \*****************************************/
/*! exports provided: VllazniaService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VllazniaService", function() { return VllazniaService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var VllazniaService = /** @class */ (function () {
    function VllazniaService(http) {
        this.http = http;
        //apiUrl = 'http://api.albaniasoccer.com/';
        this.apiNews = 'http://www.fkvllaznia.net/main/app/';
    }
    VllazniaService.prototype.getHomeNews = function () {
        return this.http.get(this.apiNews + 'lajme.php?nr=3')
            .pipe(
        //tap(_ => this.log('fetched news')),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getHomeNews', [])));
    };
    VllazniaService.prototype.getAllNews = function () {
        return this.http.get(this.apiNews + 'lajme.php')
            .pipe(
        //tap(_ => this.log('fetched news')),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getHomeNews', [])));
    };
    VllazniaService.prototype.getInfoNews = function (newsId) {
        return this.http.get(this.apiNews + 'lajme.php?id=' + newsId)
            .pipe(
        //tap(_ => this.log('fetched news')),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getHomeNews', [])));
    };
    VllazniaService.prototype.handleError = function (operation, result) {
        var _this = this;
    ...
    VllazniaService.prototype.log = function (message) {
        console.log(message);
    };
    VllazniaService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    VllazniaService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], VllazniaService);
    return VllazniaService;
}());
