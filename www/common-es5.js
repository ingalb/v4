...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppApiVllazniaServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "VllazniaService", function () {
    ...
    let VllazniaService = class VllazniaService {
      ...
      getHomeNews() {
        return this.http.get(this.apiNews + 'lajme.php?nr=3').pipe( //tap(_ => this.log('fetched news')),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getHomeNews', [])));
      }

      getAllNews() {
        return this.http.get(this.apiNews + 'lajme.php').pipe( //tap(_ => this.log('fetched news')),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getHomeNews', [])));
      }
    ...
    VllazniaService.ctorParameters = () => [{
      type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
    }];

    VllazniaService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], VllazniaService);
    /***/
  }
}]);
